...
> ⚠️ **SPENT 2026-08-28, AND A SECOND WINDOW IS NOW RUNNING — annotated, not rewritten.** The
> annotation above records the **first** window: T0 `2026-08-22T17:59:26Z`, strict mark
> `2026-09-05T17:59:26Z`. **Both are SPENT.** PR
> [#431](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/431) (`288667d`) took the Vitest
> corpus **231 → 245** on 2026-08-27 and re-engaged this subsection's own restart clause. **The
> current window's T0 is `2026-08-27T23:18:21Z` and its strict mark is `2026-09-10T23:18:21Z`**,
> declared by owner ruling on 2026-08-29 in **§13.0** — which remains the only place a T0 may be
> declared, so **read it there and never from here**.
>
> **This subsection's *"final expansion packet"* gloss — *"the last of A, B, C to merge"* — is the
> step-12 lettered reading and is preserved as exactly that.** The 2026-08-29 ruling supplies the
> operative definition for the current cycle: **the last change merged before this qualification
> window that added, removed, renamed or materially changed a case under
> `static/js/**/*.test.js`**. Everything else in this subsection — that the clock starts on `main`
> and on a **successful** run, and that any `js-unit` failure resets it to zero — is unchanged and
> still binds.
...
> ⚠️ **ANNOTATION 2026-08-29 — the paragraph above is the `2026-08-26T23:37:12Z` reading and is
> left as one; the TABLE below has since grown past it.** *"The sixteen rows below"* was true at
...
| **27** | [`33211850477`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33211850477) | `push` / `878057f` (PR #439, Track P1 pyright — `_create_exercise` None muscle groups) | `success`, **18/18** | [**`98986664528`**](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33211850477/job/98986664528) | **`success`** | **`2026-08-28T21:17:03Z`** |
| **28** | [`33211894189`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33211894189) | `push` / `8a53fd3` (PR #440, Track P1 pyright — `get_backup_details` in `test_program_backup`) | `success`, **18/18** | [**`98986802288`**](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33211894189/job/98986802288) | **`success`** | **`2026-08-28T21:18:03Z`** |
| **29** | [`33211923147`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33211923147) | `push` / `cc72162` (PR #441, Track P1 pyright — calibration integration payload) | `success`, **18/18** | [**`98986904544`**](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33211923147/job/98986904544) | **`success`** | **`2026-08-28T21:18:42Z`** |
| **30** | [`33211949359`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33211949359) | `push` / `3e60cdd` (PR #442, Track P1 pyright — `tests/test_db_migration.py`) | `success`, **18/18** | [**`98986991921`**](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33211949359/job/98986991921) | **`success`** | **`2026-08-28T21:20:44Z`** |
| **31** | [`33211983925`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33211983925) | `push` / `f318d81` (PR #444, Track P1 integration — four workers; baseline left at 123 / 40 / 24 by design, its `123 → 108` title figure being branch-local — [`OPEN_WORK_EXECUTION_PLAN.md`](../OPEN_WORK_EXECUTION_PLAN.md) §14.2 Trap 1) | `success`, **18/18** | [**`98987095494`**](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33211983925/job/98987095494) | **`success`** | **`2026-08-28T21:21:22Z`** |
| **32** | [`33214277617`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33214277617) | `push` / `c6cfe31` (PR #443, Track P1 — `reportOptionalSubscript` cluster plus the baseline regeneration, 123 → 37) | `success`, **18/18** | [**`98994314546`**](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33214277617/job/98994314546) | **`success`** | **`2026-08-28T21:50:54Z`** |
| **33** | [`33214775557`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33214775557) | `push` / `2035852` (**PR #438, JS-unit ledger rows 24–26 and the recorded window restart** — the carrier of the rows 24–26 extension) | `success`, **18/18** | [**`98995846638`**](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33214775557/job/98995846638) | **`success`** | **`2026-08-28T21:57:45Z`** |
| **34** | [`33216840672`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33216840672) | `push` / `3807011` (PR #436, Open Work Execution Plan reconciled to `2035852`) | `success`, **18/18** | [**`99002264978`**](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33216840672/job/99002264978) | **`success`** | **`2026-08-28T22:27:21Z`** |
| **35** | [`33227220925`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33227220925) | `push` / `1226e46` (PR #446, Track P1 integration — six workers, 37 / 16 / 11 → 9 / 2 / 1) | `success`, **18/18** | [**`99033174343`**](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33227220925/job/99033174343) | **`success`** | **`2026-08-29T01:45:23Z`** |
| **36** | [`33253693943`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33253693943) | `push` / `3532f86` (PR #447, Track P1 close — `routes/workout_plan.py`, 9 / 2 / 1 → 0 / 0 / 0) | `success`, **18/18** | [**`99103640118`**](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33253693943/job/99103640118) | **`success`** | **`2026-08-29T12:55:27Z`** |
| **37** | [`33255921889`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33255921889) | `push` / `158ee40` (PR #445, the owner status board — §15 of the Open Work Execution Plan) | `success`, **18/18** | [**`99109487854`**](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33255921889/job/99109487854) | **`success`** | **`2026-08-29T13:48:04Z`** |
| **38** | [`33264331296`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33264331296) | `push` / `225b7b0` (PR #448, `REFACTOR_PLAN.md` reconciled to Track P1's closure) | `success`, **18/18** | [**`99131593513`**](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33264331296/job/99131593513) | **`success`** | **`2026-08-29T16:57:25Z`** |
...
| **45** | [`33280011412`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33280011412) | `push` / `fcc0e59` (**PR #453, Testing Strategy D4 SIGNED — bounded scope, ADR-009, Gate 1 plan**) | `success`, **18/18** | [**`99173480852`**](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33280011412/job/99173480852) | **`success`** | **`2026-08-29T23:03:22Z`** |
...
> ✅ **SUPERSEDED 2026-08-29 — T0 IS NOW DECLARED.** The owner ruled that #431 **was** the final
> expansion packet, so `2026-08-27T23:18:21Z` is **T0**, not a conditional, and the strict mark is
> **`2026-09-10T23:18:21Z`** — recorded in this section under *OWNER RULING — #431 IS THE FINAL
> EXPANSION PACKET*. **The paragraph below is preserved as the reading it was**, and it was right to
> decline to declare a T0 it had no authority to declare. **Two of its clauses are now false of
> `main` and are named here rather than left to be discovered:** *"two Vitest expansions are still
> deferred and unlanded"* — **one** is (U1-FOLLOWUP-1, re-anchored to `2026-09-10T23:18:21Z`),
> while U3b's is **RETIRED**; and *"is an owner determination and is OWED"* — it is **MADE**.
...
#### OWNER RULING — #431 IS THE FINAL EXPANSION PACKET; T0 IS DECLARED — 2026-08-29

> **This subsection declares the T0 every block above deliberately left conditional.** It is the
> owner's ruling, recorded here because §13.0 is the only place a T0 may be declared. **It declares
> a T0 and nothing else** — **Q4** and **D2** remain unsigned, `JS Unit (Vitest, non-required)`
> remains **non-required**, and no branch-protection change is authorized or proposed.

**The ruling, as given (owner, 2026-08-29):**

> For the purposes of ruling **Q2** and the current JS-unit qualification cycle, **PR
> [#431](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/431) (`288667d`) is the FINAL
> Vitest expansion packet.** *"Final expansion packet"* means **the last change merged before this
> qualification window that added, removed, renamed or materially changed a case under
> `static/js/**/*.test.js`**.
>
> - **Qualifying T0: `2026-08-27T23:18:21Z`**
> - **Source: job `98703428098` on run `33125767570`**
> - **Strict 14-day mark: `2026-09-10T23:18:21Z`**
>
> **U1-FOLLOWUP-1 remains OPEN and required**, with its no-landing-before date **re-anchored from
> `2026-09-05T17:59:26Z` to `2026-09-10T23:18:21Z`**. Before it is planned, its coverage
> requirements must be re-read against U3b's amended announce condition, recorded as **K13**. **Its
> eventual post-mark landing does not retroactively invalidate a successfully completed
> qualification cycle.**
>
> **U3b / KI-011 Vitest helper coverage is RETIRED.** **OQ-10** authorized E2E-only coverage and
> created **no** Vitest follow-up. Reviving that coverage requires a **new packet and its own
> Gate 0.**

**What the ruling settles, and what it does not.** It settles the *"final expansion packet"*
definition that §6.5's own gloss — *"the last of A, B, C to merge"* — could not stretch to cover a
defect fix that moved the corpus, and it converts row 26's timestamp from a conditional into the
operative **T0**. It does **not** promote `js-unit`, does **not** decide **Q4** or **D2**, does
**not** authorize U1-FOLLOWUP-1's implementation, and touches **no** JS test.

**Re-measured before recording, not copied forward.** Every figure below was re-read from the
GitHub API in the recording session, at UTC now **`2026-08-29T19:32:58Z`** (response `Date` header,
not the host clock):

| Item | Measured value |
|---|---|
| T0 job | [`98703428098`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33125767570/job/98703428098), name matched on the exact context string `JS Unit (Vitest, non-required)`, `conclusion` **`success`**, `completed_at` **`2026-08-27T23:18:21Z`** |
| Its run | [`33125767570`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33125767570) — `.github/workflows/ci.yml`, event `push`, head **`288667d`** (#431's squash), `conclusion` **`success`** |
| T0 + 14 days | **`2026-09-10T23:18:21Z`** |
| Suite being qualified | **13 files / 245 cases** |
| Window integrity, rows 26–41 | **16 consecutive green**; **0** red, **0** missing, **0** skipped, **0** cancelled |

**T0 is a job `completed_at`, never a `mergedAt`.** #431 merged at `2026-08-27T23:17:50Z`; the
31-second gap is the run's queue and job time, and quoting the `mergedAt` in its place would move
the strict mark by the same amount.

---

> **LEDGER EXTENSION — `2026-08-29T17:59:51Z`, rows 27–40.** The most recent tally above — the
> rows 24–26 one, at `2026-08-27T23:18:21Z` — was true at that moment and is **annotated, not
> rewritten**, as every extension before it has been; the live reading is below. **Fourteen** `main`
> `ci.yml` runs have landed since, all fourteen read at job level — the `js-unit` job's own
> `conclusion` and `completed_at`, never the run's overall conclusion. Read from the API at
> **`2026-08-29T18:12:28Z`** (UTC now, taken from the GitHub API response `Date` header, not from
> the host clock), after run `33267048668` reached `completed` with **zero** pending jobs.
>
> Rows 27–32 are the 2026-08-28 Track P1 merge wave
> ([#439](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/439), #440, #441, #442, #444,
> #443, in landing order rather than PR-number order). **Row 33 is
> [#438](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/438)'s own landing** — the PR
> that wrote rows 24–26 and could not cite the run its own merge produces, the same mechanism rows
> 24, 23, 20 and 17 record. Row 34 is #436's, rows 35 and 36 are #446's and #447's, and **row 37 is
> [#445](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/445)'s** — the owner-status-board
> PR, whose own diff predicted that row, in §16.3 of
> [`OPEN_WORK_EXECUTION_PLAN.md`](../OPEN_WORK_EXECUTION_PLAN.md), and correctly declined to claim
> it as recorded. **Rows 38, 39 and 40 are the three documentation PRs that landed after it** —
> [#448](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/448) (`225b7b0`),
> [#449](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/449) (`5664c0e`) and
> [#451](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/451) (`fe15225`), in that landing
> order. **Whoever merges THIS PR owes the next unclaimed row, which is row 41.**
>
> **Row order was checked, not assumed.** Sorting the fourteen runs by `created_at` and by their
> `js-unit` job's `completed_at` yields the **same** sequence, so no row number here is ambiguous.
> Five of the fourteen runs were created inside a **112-second** span
> (`2026-08-28T21:16:42Z` → `21:18:34Z`) as the Track P1 wave landed, and **none was cancelled or
> superseded**: `ci.yml`'s concurrency group is
> `${{ github.workflow }}-${{ github.event.pull_request.number || github.run_id }}`, so a push run
> falls back to `github.run_id` and is alone in its group — a rapid push to `main` cannot cancel a
> queued sibling. That was read off each run's own `status`,
> `conclusion` and `run_attempt` — all fourteen `completed` / `success` / attempt **1**.
>
> **The whole ledger was re-derived, not extended from the page**, as this block's own standing
> rule requires. All **40** rows — not merely the fourteen new ones — had their run's `/jobs`
> re-fetched and their run id, `js-unit` job id, job `conclusion` and job `completed_at` compared
> against what this table already carried: **40 of 40 agree, zero mismatches**, and every one of
> the 40 runs re-read as **18 jobs / 18 `success`**. The rows above are therefore a fresh reading
> that happens to equal the page, which is what "re-derive" means here.

> **LEDGER EXTENSION — `2026-08-29T19:32:58Z`, row 41.** **Row 41 is appended to the master ledger
> table above, in place**, as this block's standing rule requires — not restated in a table of its
> own. The **rows 27–40 tally**, taken at `2026-08-29T18:12:28Z`, sits *below* the row-41 tally that
> follows this block and is **annotated, not rewritten**, as every extension before it has been; the
> **live reading is the row-41 tally immediately below this block**. **One** `main` `ci.yml` run has
> landed since row 40, read at job level — the `js-unit` job's own `conclusion` and `completed_at`,
> never the run's overall conclusion.
>
> **Row 41 is [#450](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/450)'s own landing**
> — the PR that wrote rows 27–40 and could not cite the run its own merge produces, the same
...
> **[`2026-08-22T17:00:00Z`, `2026-08-29T19:32:58Z`]** — the lower bound deliberately **earlier**
> than the original T0, so the filter is a superset and cannot hide a run — returns **46** `main`
> runs of **any** workflow: **41** `ci.yml` `push` attempts plus the **5** classified non-attempts.
> A cross-check **without** the branch filter, over three unfiltered pages filtered to
> `head_branch == "main"` and `created_at > 2026-08-29T17:59:26Z`, returns the **same single** run,
> so the branch-filtered query hides nothing.

**Row 41, as written into the master table above:** run
[`33268787682`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33268787682),
head `116d3c5` ([#450](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/450)), `js-unit`
job [`99143431684`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33268787682/job/99143431684),
conclusion **`success`**, `completed_at` **`2026-08-29T18:38:17Z`**.

Row 41's run is `CI/CD Pipeline` on `push`, `completed` / `success`, **18 jobs and 18 `success`**,
and **attempt 1** — read off the run's own `status`, `conclusion` and `run_attempt`, with the
`js-unit` row taken from its `/jobs` enumeration rather than inferred from the run.

**Row 41 restarts nothing, and its head is the tree this ruling's T0 is measured against.**
`git rev-parse 116d3c5:static/js` returns **`a7e5073568b0fde8e35e1e1a7be5a9f844e77828`**,
`116d3c5:static/js/modules/__tests__` returns **`5858c8497c571548e5116f4b660ff7702dd298b1`**, and
`116d3c5:vitest.config.js` returns `c16ca428f7478708d8dd96a20ebcb86f98a8b935` — identical at all
**sixteen** heads from `288667d` through `116d3c5`, so the entire production JS tree, the whole
Vitest corpus and the collection mechanism are byte-identical across the window.
[`TEST_INVENTORY.json`](../test_inventory/TEST_INVENTORY.json) at `116d3c5` reads
`vitest.total_files = 13`, `vitest.total_cases = 245`. **Q2's restart clause did not engage at row
41**; its carrier, #450, was documentation-only.

**The five non-attempt runs are unchanged, and were re-enumerated rather than carried forward.**
Each had its `/jobs` re-fetched at this read and each returned **zero**
`JS Unit (Vitest, non-required)` jobs: the three Dependabot `dynamic` runs (`32676594582`,
...
> the next pass's to write.**~~ ✅ **DISCHARGED — #453's row is written below as row 45**, in
> the rows-45–48 extension, by the same pass that carried this block.
>
> **The enumeration is independent and bounded at both ends.**
> `gh api "repos/:owner/:repo/actions/runs?branch=main&per_page=100"`, filtered to `created_at` in
...
> has landed.**~~ ⚠️ **SPENT — a sixth landed at `2026-08-29T23:21:50Z`**: run
...
> `success`. It is classified the same way as the other five and returns **zero**
> `JS Unit (Vitest, non-required)` jobs, so **no tally figure moves** — only the completeness
> total, 49 → 54. Re-derived in the rows-45–48 extension below. The sentence was true when
> written and is preserved as the dated reading it was.
...
> **LEDGER EXTENSION — `2026-08-29T23:54:19Z`, rows 45–48.** **All four rows are appended to
> the master ledger table above, in place.** Each was minted by an owner merge that landed while
> the closeout PR carrying this extension was open; **none of the four touched the ledger**, so all
> four were unclaimed, and this pass claims them. In merge order: **row 45** =
> [#453](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/453) (`fcc0e59`), which **signed Testing Strategy D4**;
> **row 46** = [#460](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/460) (`e9f942f`), **D4 Packet A**; **row 47** =
> [#459](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/459) (`bd686c9`), the *Packet R1* disambiguation; **row 48** =
> [#461](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/461) (`7d9a836`), **D4 Packet B**.
>
> **Read at job level**, each one — the `js-unit` job's own `conclusion` and `completed_at`, never
> the run's overall conclusion. Every one of the four is `completed` / `success` on **attempt 1**,
> and each run-level **18 / 18** was taken only after that run itself reached `completed`. Row 48's
> job finished at `2026-08-29T23:44:01Z`, roughly twenty minutes ahead of its own run — which is
> exactly why the job is the unit of record and the run is not.
>
> **Rows 46 and 48 change CALCULATION SEMANTICS — the first such change inside this window.**
> #460 changed `utils/effective_sets.py`, `utils/session_summary.py` and `utils/weekly_summary.py`;
> #461 changed `utils/effective_sets.py`; both changed the summary templates. **This is not the
> window's first production diff**, and the distinction matters enough to state rather than blur:
> rows **31**, **35** and **36** — the Track P1 pyright burn-down (`f318d81`, `1226e46`, `3532f86`)
> — already touched `routes/**` and `utils/**` inside this window, as type-annotation work. What is
> new at rows 46 and 48 is a deliberate change to a **documented effective-sets calculation**.
>
> **Q2's restart clause still did not engage**, and the reason is worth stating rather than
> assuming: the clause keys on a change to a **JS test case** under `static/js/**/*.test.js`. It
> does not key on production code, and it does not key on the pytest corpus — which did move, by
> #460's and #461's additions. **A production change inside the window is not a restart.** It is,
> however, exactly the kind of change this window exists to be evidence about, so it is recorded
> here explicitly rather than folded silently into a count.
>
> **Whoever merges the PR carrying this extension owes the next unclaimed row**, which it cannot
> record — the standing §11.10 mechanism, unchanged. **No fixed number is written here,
> deliberately**, and this pass is now the second demonstration in a row of why: it predicted a
> number once, [#453](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/453) took it within the hour, and by the time the
> correction was written [#460](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/460), [#459](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/459) and
> [#461](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/pull/461) had taken three more. Track D1's rule in
> [`OPEN_WORK_EXECUTION_PLAN.md`](../OPEN_WORK_EXECUTION_PLAN.md) §4 is the standing form: name the
> obligation, never the integer.
>
> **The enumeration is independent and bounded at both ends.**
> `gh api "repos/:owner/:repo/actions/runs?branch=main&per_page=100"` over three pages, filtered to
> `created_at` in **[`2026-08-22T17:00:00Z`, `2026-08-29T23:54:19Z`]**, returns **54** `main` runs of **any**
> workflow: **48** `ci.yml` `push` attempts plus **6** classified non-attempts. The lower bound is
> deliberately earlier than either T0, so the filter is a **superset** of the window and cannot hide
> a run by clipping it. **The non-attempt set grew by one** — run
> [`33280804027`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33280804027), *Configured Graph Update: pip in /.*, `dynamic`,
> `2026-08-29T23:21:50Z` — and **all six were re-checked individually**, each returning **zero**
> `JS Unit (Vitest, non-required)` jobs. **No tally figure moves because of it**; only the
> completeness total does, 49 → 54. A cross-check **without** the branch filter, filtered to
> `head_branch == "main"` and `created_at > 2026-08-29T22:43:40Z`, returns the **same four** new
> attempts and the **same one** new non-attempt. **`schedule`-event `ci.yml` runs in the window
> remain 0**; the single `schedule` run in range is the 2026-08-24 *Deep Gate*, which is not
> `ci.yml`.

**Rows 45–48 restart nothing, and this is now measured across a production change.**
`git rev-parse <sha>:static/js` returns **`a7e5073568b0fde8e35e1e1a7be5a9f844e77828`**,
`<sha>:static/js/modules/__tests__` returns **`5858c8497c571548e5116f4b660ff7702dd298b1`** and
`<sha>:vitest.config.js` returns `c16ca428f7478708d8dd96a20ebcb86f98a8b935` — **byte-identical at
all twenty-three heads** from `288667d` through `7d9a836`, `fcc0e59`, `e9f942f` and `bd686c9`
...
|---|---:|
| **Qualification attempts** — `main` `CI/CD Pipeline` (`ci.yml`) runs at or after the original T0 | **48** — all forty-eight `push`, all 18/18, all attempt **1** |
| Green `main` `JS Unit` results since and including the original T0 | **48** |
| **Red** results | **0** |
| **Missing** results (a `main` **`ci.yml`** run with no `js-unit` job) | **0** |
| **Skipped** results | **0** |
| **Cancelled** results | **0** |
| `main` runs of **any** workflow at or after the original T0 **and at or before this read** (completeness check, not a tally) | **54** — the 48 attempts plus **6** classified non-attempts, one more than at the row-44 read |
| **`schedule`-event `ci.yml` runs in the window** | **0** |
| **Green results on the 231-case suite (rows 1–25)** | **25** |
| **Green results on the 245-case suite (rows 26–48)** | **23** |
| **Rows carrying a production-code change (rows 46 and 48)** | **2** — the first in this window |
| Elapsed from **T0** (`2026-08-27T23:18:21Z`) to row 48 | **2 d 0 h 25 m 40 s** |
| Remaining from row 48 to the strict mark **`2026-09-10T23:18:21Z`** | **11 d 23 h 34 m 20 s** |
...
|---|---:|
| **Qualification attempts** — `main` `CI/CD Pipeline` (`ci.yml`) runs at or after the original T0 | **41** — all forty-one `push`, all 18/18, all attempt **1** |
| Green `main` `JS Unit` results since and including the original T0 | **41** |
| **Red** results | **0** |
| **Missing** results (a `main` **`ci.yml`** run with no `js-unit` job) | **0** |
| **Skipped** results | **0** |
| **Cancelled** results | **0** |
| `main` runs of **any** workflow at or after the original T0 **and at or before this read** (completeness check, not a tally) | **46** — the 41 attempts plus the same **5** classified non-attempts, re-enumerated at this read and **unchanged in membership** |
| **`schedule`-event `ci.yml` runs in the window** | **0** |
| **Green results on the 231-case suite (rows 1–25)** | **25** |
| **Green results on the 245-case suite (rows 26–41)** | **16** |
| Elapsed from **T0** to row 41 | **1 d 19 h 19 m 56 s** — **no longer a conditional figure**: T0 is declared above |
| Remaining from row 41 to the strict mark **`2026-09-10T23:18:21Z`** | **12 d 4 h 40 m 4 s** |

---

| Ledger tally, at `2026-08-29T18:12:28Z` | Value |
|---|---:|
| **Qualification attempts** — `main` `CI/CD Pipeline` (`ci.yml`) runs at or after the original T0 | **40** — all forty `push`, all forty 18/18, all attempt **1** |
| Green `main` `JS Unit` results since and including the original T0 | **40** |
| **Red** results | **0** |
| **Missing** results (a `main` **`ci.yml`** run with no `js-unit` job) | **0** |
| **Skipped** results | **0** |
| **Cancelled** results | **0** |
...
| Elapsed from row 26 to row 40 | **1 d 18 h 41 m 30 s** — a **conditional** figure: it is a fourteen-day window's elapsed time only if row 26's timestamp is T0, which **this block does not declare** |
| Remaining from row 40 to the **conditional** `2026-09-10T23:18:21Z` mark | **12 d 5 h 18 m 30 s**, on the same condition |

**Rows 27–40 restart nothing, and the measurement covers every one of the fourteen — not merely the
endpoints.** `git rev-parse <sha>:static/js` returns **`a7e5073568b0fde8e35e1e1a7be5a9f844e77828`** at **all
fifteen** of `288667d`, `878057f`, `8a53fd3`, `cc72162`, `3e60cdd`, `f318d81`, `c6cfe31`,
`2035852`, `3807011`, `1226e46`, `3532f86`, `158ee40`, `225b7b0`, `5664c0e` and `fe15225` — so the
**entire production JS tree**,
not merely the Vitest corpus, is byte-identical from row 26's head through row 40's, at every
commit in between. The narrower *"changed no JS test case"* measurement holds a fortiori:
`git rev-parse <sha>:static/js/modules/__tests__` is
**`5858c8497c571548e5116f4b660ff7702dd298b1`** at all fifteen, and `vitest.config.js` is
`c16ca428f7478708d8dd96a20ebcb86f98a8b935` at all fifteen, so the collection mechanism did not move
either. [`TEST_INVENTORY.json`](../test_inventory/TEST_INVENTORY.json) reads
`vitest.total_files = 13`, `vitest.total_cases = 245` at **all fifteen** as well — the inventory was
read at each head, not merely at the two ends.
**Q2's restart clause did not engage at any of the fourteen rows.**

**The fourteen carriers, for the record:** **eight** Track P1 pyright packets over `tests/**`,
`utils/**` and — in #447's case, under the owner authorization recorded in
[`OPEN_WORK_EXECUTION_PLAN.md`](../OPEN_WORK_EXECUTION_PLAN.md) §4 Track P1 —
`routes/workout_plan.py`; and **six** documentation-only PRs, #438, #436, #445, #448, #449 and
#451. **The tree hashes above, not this list, are the evidence.**

**The completeness census is bounded at both ends.** The
45-run figure counts `main` runs of **any** workflow created at or after `2026-08-22T17:00:00Z` —
deliberately **earlier** than the original T0, so the filter is a superset and cannot hide a run —
and at or before this block's `2026-08-29T18:12:28Z` read. **An unbounded query would return a
larger number the moment the next run starts**, and would not be this reading. Method, identical
to every block above: `gh api "repos/:owner/:repo/actions/runs?branch=main&per_page=100"`, then
full `/jobs` enumeration on each returned run, matched on the exact context string
`JS Unit (Vitest, non-required)`. The page returned runs back to `2026-08-14T20:12:43Z`, well
before the filter's lower bound, so the window is not truncated by pagination.

**Two measured details of the five non-attempt runs differ from the classification table above,
and are recorded here rather than by rewriting it.** Re-enumerating each run's `/jobs` at this read
returns, for [`33017596325`](https://github.com/AvihaiShai/Hypertrophy-Toolbox-v3/actions/runs/33017596325),
a workflow path of `dynamic/dependabot/update-graph` and a single job named **`update-pip-graph`**
— not the `dynamic/dependabot/dependabot-updates` path and `Dependabot` job name that table
carries. **Its classification is unchanged**: still not a `ci.yml` run, still **zero** `JS Unit`
jobs. The table above is a dated reading and is left as one.

> ✅ **SUPERSEDED 2026-08-29 — see *OWNER RULING — #431 IS THE FINAL EXPANSION PACKET* above.**
> T0 is declared: **`2026-08-27T23:18:21Z`**, strict mark **`2026-09-10T23:18:21Z`**. The paragraph
> below is preserved as the `2026-08-29T18:12:28Z` reading it was; both its *"still OWED"* clause and
> its pairing of U3b's coverage with U1-FOLLOWUP-1 are spent.

**T0 is still not declared here.** The restart is recorded at row 26 as a measured fact; whether
`2026-08-27T23:18:21Z` is T0 turns on whether #431 was the *final* expansion packet, which is an
**owner determination and still OWED** — U3b's KI-011 helper coverage and **U1-FOLLOWUP-1** remain
unlanded. The corpus did not move across rows 27–40, so that question is exactly where the
rows-24–26 extension left it.
...
> ⚠️ **SUPERSEDED 2026-08-29 — U3b's KI-011 Vitest helper coverage is RETIRED, not deferred.**
> The owner ruled that **`OQ-10` authorized E2E-only coverage and created no Vitest follow-up**;
> reviving that coverage requires a **new packet and its own Gate 0**. **The paragraph below is
> preserved as the reading it was, and its central claim is precisely what is superseded**: it
> treated the coverage as *"deferred exactly as U1-FOLLOWUP-1 is"*, an equivalence U3b's signed
> §1 ruling never created — `OQ-10` reads *"E2E-only fixed-behavior regression"* and stops there,
> and `toast_action_continuity/PLANNING.md` registers no Vitest follow-up obligation anywhere.
> **U1-FOLLOWUP-1 alone remains OPEN and required**, re-anchored to `2026-09-10T23:18:21Z`.
