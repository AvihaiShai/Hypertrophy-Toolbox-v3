...
**Three of those deferrals have since been taken up.** X11, X12 and X13 shipped in **#392** as the
...
2. A row marked **Owner decision needed** must not be fixed as a side effect of another packet; it
   ...
   were later taken up and shipped in #392; X7–X10 and X15 remain deferred.
