...
> **⛔ CLOSED 2026-08-13 — owner decision: insufficient real-use evidence, no threshold change.** **No edit to `utils/fatigue.py`** — `MUSCLE_VOLUME_LANDMARKS`, `SESSION_FATIGUE_BANDS`, and `WEEKLY_FATIGUE_BANDS` remain the BRAINSTORM §5 / §24.B defaults.
