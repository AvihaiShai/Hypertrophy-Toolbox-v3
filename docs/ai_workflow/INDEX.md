...
- [Testing strategy](../TESTING_STRATEGY_PLANNING.md) — Phases 0–1 shipped; Phase-2 Packet A shipped as #342 (`1438a14`), while strict-console Packet C and axe Packet D remain queued in [`testing_phase2/PLANNING.md`](../testing_phase2/PLANNING.md). D4, D7 and the `js-unit` half of D2 remain unsigned (D6 signed 2026-08-14 as retain-informational, ADR-008); Phases 3/5 and the release/tag half of Phase 4 remain proposals
