...
- [Testing strategy](../TESTING_STRATEGY_PLANNING.md) — Phases 0–1 shipped; **Phase 2 is COMPLETE** — Packet A #342 (`1438a14`), Packet C #362 (`52331bf`), Packet D #366 (`f627161`), closed by #372 (`385ce52`). The release/tag half of Phase 4 SHIPPED as Packet R1, #374 (`5222db2`), with Phase 4 itself still open on §7.3 entry criteria 2 and 3. Detail in [`testing_phase2/PLANNING.md`](../testing_phase2/PLANNING.md). D4, D7 and the `js-unit` half of D2 remain unsigned (D6 signed 2026-08-14 as retain-informational, ADR-008); Phases 3 and 5 remain proposals
