...
| Metric | Value |
|---|---|
| Playwright tests (chromium) | **633** |
| Playwright spec files | **33** |
| Required functional gate — `E2E Functional (Chromium)` | **500** tests across 25 specs |
| pytest collected nodes (deterministic subset) | **2535** across 118 files |
