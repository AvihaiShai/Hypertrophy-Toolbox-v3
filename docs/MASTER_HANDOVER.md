...
- **The app.py review is CLOSED** (2026-08-01) — all five packets merged. No
  decision is open on it; see [`APP_PY_REVIEW_PLAN.md`](APP_PY_REVIEW_PLAN.md) §7.
- **Two planning documents remain parked pre-approval** — the product
  ...
  started; each needs its own owner decision.
