...
rendering observations are **historical accepted residuals** under ADR-011's 2026-08-30 terminal
81-byte/5-semantic contract, recorded in [`MASTER_HANDOVER.md`](MASTER_HANDOVER.md) § *Known
Windows visual reds*. They are no longer open policy items, and the rendering defect is not
declared fixed.
...
**Two residual categories are recorded here but owned elsewhere; do not schedule them from
this file.** The two WP4.0 Windows rendering observations are accepted terminal residuals under
ADR-011 and belong to [`MASTER_HANDOVER.md`](MASTER_HANDOVER.md) § *Known Windows visual reds*; the
