...
> file.** Everything that remains is OWNER-gated (P2.1, P2.2, P2.4, the §4
> taxonomy TODOs, and the `npm audit` severity/exception policy) or a PROPOSAL
...
**Current classification (v24, 2026-08-13, superseding v23's):** **no item in this
...
(and P2.6, shipped 2026-08-04). **OWNER** — P2.1, P2.2, P2.4. Every item in P3 is a
**PROPOSAL**. See the v24 block above for the per-item evidence and §6 for the queue.
...
decisions (P2.1, P2.2, P2.4 and the §4 TODOs). **Every bullet below is still a
...
|---|---|---|
| **P2.1** Fatigue *Phase 2* Stage 4 disposition | **OWNER** — restart real-use collection, or close the inactive window; Learned Calibration 2D-D is parked on the same missing evidence | owner |
