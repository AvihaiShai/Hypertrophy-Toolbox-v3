...
worktrees must be excluded); **OWNER** — P1.3, P1.8, P2.1–P2.4; every item
in P3 is a **PROPOSAL**.
...
**P1.0 has shipped** (#278) and **P1.1 has shipped** (#295) — both are in §2 and
are no longer steps in this sequence. What remains of it is: **P1.7**
